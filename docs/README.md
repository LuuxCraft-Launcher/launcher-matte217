...
<h1 align="center">survie moder priv launcher</h1>
...
Si vous téléchargez à partir des Releases, sélectionnez le programme d'installation de votre système.
 ...
 Plateforme | Fichier |
| -------- | ---- |
| Windows x64 | `Survie-moder-Priv.-launcher-win-x64.exe ` |
| macOS | `Survie-moder-Priv.-launcher-mac-universal.dmg` |
| Linux x64 | `Survie-moder-Priv.-launcher-linux-x86_64.AppImage` |
